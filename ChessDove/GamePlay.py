...
#Promotion: Check if pawn is in the last row, if so, promote to a queen (not yet able to underpromote or choose what to promote into)
...
for times in range(times):
    ...
    for epoch in range(epochs):
        ...
        while ChessDove.check_con(newpos, ChessDove.turn, legalmove, last_move, pos_his, gamehis):
            ...
            if action == ((7, 4), (7, 6)) and newpos[7][4] == 6 or action == ((7, 4), (7, 2)) and newpos[7][4] == 6:
            ...
            if blackaction == ((0, 4), (0, 6)) and newpos[0][4] == -6 or blackaction == ((0, 4), (0, 2)) and newpos[0][4] == -6:
